...
T::T(Grid *gameGrid, int blockid, int lvl) : g{gameGrid}, level{lvl} {
...
void T::updateStates() {
  ...
  vec1.emplace_back(Coordinate{leftRef.row - 1, leftRef.col + 2});
  ...
  vec2.emplace_back(Coordinate{leftRef.row, leftRef.col + 1});
  ...
  vec3.emplace_back(Coordinate{leftRef.row, leftRef.col});
  vec3.emplace_back(Coordinate{leftRef.row - 1, leftRef.col});
  vec3.emplace_back(Coordinate{leftRef.row - 2, leftRef.col});
  ...
  vec4.emplace_back(Coordinate{leftRef.row, leftRef.col + 2});
