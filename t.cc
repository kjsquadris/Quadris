...
T::T(Grid *gameGrid, int lvl) : g{gameGrid}, level{lvl} {
...
void T::updateStates() {
  ...
  vec1.emplace_back(Coordinate{leftRef.x - 1, leftRef.y});
  ...
  vec2.emplace_back(Coordinate{leftRef.x - 2, leftRef.y + 1});
  states[1] = vec2;
